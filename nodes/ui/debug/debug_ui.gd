...
func update_debug_data(global_mouse_position : Vector2):
	...
	var tilemap_local_position : Vector2i =  tilemap.to_local(new_global_position)
	var coordinates : Vector2i = tilemap.get_coordinates_from_position(tilemap_local_position)
